...
const BlogPostCard: FC<Props> = ({
  ...
  return (
    <li className="[&>*]:whitespace-normal py-2 snap-center px-4 shadow space-y-6 first:ml-0 last:mr-0 mx-1.5 sm:mx-4 bg-surface w-[372px] max-w-[calc(100vw-42px)] flex-shrink-0">
